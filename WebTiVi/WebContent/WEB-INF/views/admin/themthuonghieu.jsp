...
<title>Trùm Điện Máy | Thêm thương hiệu</title>
...
<body>
	...
	<div>
		...
		<div class="row">
			<form:form action="thuong-hieu/them.htm" method="post" modelAttribute="thuongHieu">
				<div class="form-group">
					<label for="maTH">Mã thương hiệu</label>
					<form:input type="text" class="form-control" path="maTH" id="maTH" placeholder="Mã thương hiệu"/>
