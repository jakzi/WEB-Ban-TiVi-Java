...
<title>Trùm Điện Máy | Thêm danh mục</title>
...
<body>
	...
	<div>
		...
		<div class="row">
			<form:form action="danh-muc/them.htm" method="post" modelAttribute="danhMuc">
				<div class="form-group">
					<label for="maLoaiSP">Mã loại sản phẩm</label>
					<form:input type="text" class="form-control" path="maLoaiSP" id="maLoaiSP" placeholder="Mã loại"/>
					<form:errors path="maLoaiSP"/>
				</div>
				<div class="form-group">
				  <label for="tenLoaiSP">Tên loại sản phẩm</label>
				  <form:input type="text" class="form-control" path="tenLoaiSP" id="tenLoaiSP" placeholder="Tên loại sản phẩm"/>
				  <form:errors path="tenLoaiSP"/>
				</div>
