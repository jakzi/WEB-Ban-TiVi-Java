...
<title>Trùm Điện Máy | Thêm sản phẩm</title>
...
<body>
	...
	<div>
		...
		<div class="row">
			<form:form action="ad-san-pham/them.htm" method="post" modelAttribute="sanPham" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<form:input type="text" class="form-control" path="tenSP" id="tenSP" placeholder="Tên sản phẩm"/>
					<form:errors path="tenSP"/>
				</div>
				<div class="form-group">
				  <label for="gia">Giá</label>
				  <form:input type="number" class="form-control" path="gia" id="gia" placeholder="Giá"/>
				  <form:errors path="gia"/>
				</div>
				<div class="form-group">
				  <label for="giamGia">Giảm Giá $</label>
				  <form:input type="number" class="form-control" path="giamGia" id="giamGia" placeholder="Giảm giá %"/>
				  <form:errors path="giamGia"/>
				</div>
				<div class="form-group">
				  <label for="giamGia2">Giảm Giá VND</label>
				  <form:input type="number" class="form-control" path="giamGia2" id="giamGia2" placeholder="Giảm giá VND"/>
				  <form:errors path="giamGia2"/>
				</div>
				<div class="form-group">
				  <label for="soLuong">Số lượng</label>
				  <form:input type="number" class="form-control" path="soLuong" id="soLuong" placeholder="Số lượng"/>
				...
				<label>Mô tả:</label>
						<form:textarea path="moTa" rows="3" />
