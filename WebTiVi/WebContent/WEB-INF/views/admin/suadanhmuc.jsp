...
<title>Trùm Điện Máy | Sửa danh mục</title>
...
<body>
	...
	<div>
		...
		<div class="row">
			<form:form action="danh-muc/sua/${IdDM}.htm" method="post" modelAttribute="danhMuc">
				<div class="form-group">
					<label for="maLoaiSP">Mã loại sản phẩm</label>
					<input type="text" class="form-control" name="maLoaiSP" id="maLoaiSP" value="${IdDM}" disabled>
				</div>
				<div class="form-group">
